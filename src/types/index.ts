...
export type Role = 'superadmin' | 'product_manager' | 'product_technical_head' | 'service_manager' | 'sales_admin_manager' | 'sales_admin_supervisor' | 'sales_admin_assistant' | 'area_sales_manager' | 'account_executive' | 'sales_assistant' | 'user'
